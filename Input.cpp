...
void Input::draw(){
	...
	DrawCircle(mMouseX,mMouseY,AimSize,MyDx::YELLOW,FALSE);
	DrawLine(mMouseX - LineSize,mMouseY,mMouseX + LineSize,mMouseY,MyDx::YELLOW);
	DrawLine(mMouseX ,mMouseY - LineSize,mMouseX ,mMouseY + LineSize,MyDx::YELLOW);
}
